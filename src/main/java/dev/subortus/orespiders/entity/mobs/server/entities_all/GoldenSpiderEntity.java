...
public class GoldenSpiderEntity extends Spider {
    public GoldenSpiderEntity(EntityType<? extends Spider> pEntityType, Level pLevel) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(4, new GoldenSpiderAttackGoal(this));
    ...
    static class GoldenSpiderAttackGoal extends MeleeAttackGoal {
        public GoldenSpiderAttackGoal(Spider pSpider) {
        ...
        protected void checkAndPerformAttack(LivingEntity pEnemy, double pDistToEnemySqr) {
            ...
            if (pDistToEnemySqr <= d0 && this.getTicksUntilNextAttack() <= 0) {
                ...
                pEnemy.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 100, 1, true, true, true));
            }
