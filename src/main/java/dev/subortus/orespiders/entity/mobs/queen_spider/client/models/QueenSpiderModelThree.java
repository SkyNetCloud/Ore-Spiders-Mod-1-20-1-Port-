...
public class QueenSpiderModelThree<T extends QueenSpiderPhaseThreeEntity> extends HierarchicalModel<T> {
    ...
    public static LayerDefinition createThreeSpiderBodyLayer() {
