...
public class QueenSpiderModelTwo<T extends QueenSpiderPhaseTwoEntity> extends HierarchicalModel<T> {
    ...
    public static LayerDefinition createTwoSpiderBodyLayer() {
