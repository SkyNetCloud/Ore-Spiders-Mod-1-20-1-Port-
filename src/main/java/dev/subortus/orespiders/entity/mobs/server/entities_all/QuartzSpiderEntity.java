...
public class QuartzSpiderEntity extends Spider {
    public QuartzSpiderEntity(EntityType<? extends Spider> pEntityType, Level pLevel) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(4, new QuartzSpiderAttackGoal(this));
    ...
    static class QuartzSpiderAttackGoal extends MeleeAttackGoal {
        public QuartzSpiderAttackGoal(Spider pSpider) {
