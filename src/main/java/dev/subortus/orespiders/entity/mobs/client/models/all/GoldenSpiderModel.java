...
public class GoldenSpiderModel<T extends GoldenSpiderEntity> extends HierarchicalModel<T> {
    ...
    public GoldenSpiderModel(ModelPart pRoot) {
        this.root = pRoot;
    ...
    public static LayerDefinition createGoldSpiderBodyLayer() {
        ...
        PartDefinition default1 = partdefinition.addOrReplaceChild("default1", CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, 0.0F));

        PartDefinition cube_r1 = default1.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(56, 28).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -12.0F, 4.5F, 1.4399F, 0.0F, 0.0F));

        PartDefinition cube_r2 = default1.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(56, 28).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -12.0F, 11.5F, -0.6981F, 0.0F, 0.0F));
