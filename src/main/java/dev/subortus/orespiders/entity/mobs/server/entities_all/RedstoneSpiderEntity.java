...
public class RedstoneSpiderEntity extends Spider {
    public RedstoneSpiderEntity(EntityType<? extends Spider> pEntityType, Level pLevel) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(4, new RedstoneSpiderAttackGoal(this));
            ...
            if(pLooting == 0){
                if(ranNum == 1){
                    ...
                    while(i <= ammountToDrop) {
                        this.spawnAtLocation(Items.REDSTONE); //For loops aren't working for some reason.
                        i++;
                    }
                }
            } else {
    ...
    static class RedstoneSpiderAttackGoal extends MeleeAttackGoal {
        public RedstoneSpiderAttackGoal(Spider pSpider) {
        ...
        protected void checkAndPerformAttack(LivingEntity pEnemy, double pDistToEnemySqr) {
            ...
            if (pDistToEnemySqr <= d0 && this.getTicksUntilNextAttack() <= 0) {
                ...
                pEnemy.setRemainingFireTicks(40);
            }
