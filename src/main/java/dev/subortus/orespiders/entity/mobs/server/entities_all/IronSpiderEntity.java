...
public class IronSpiderEntity extends Spider {
    public IronSpiderEntity(EntityType<? extends Spider> pEntityType, Level pLevel) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(4, new IronSpiderAttackGoal(this));
    ...
    static class IronSpiderAttackGoal extends MeleeAttackGoal {
        public IronSpiderAttackGoal(Spider pSpider) {
        ...
        protected void checkAndPerformAttack(LivingEntity pEnemy, double pDistToEnemySqr) {
            ...
            if (pDistToEnemySqr <= d0 && this.getTicksUntilNextAttack() <= 0) {
                ...
                pEnemy.addEffect(new MobEffectInstance(MobEffects.BLINDNESS, 40, 1, true, true, true));
            }
