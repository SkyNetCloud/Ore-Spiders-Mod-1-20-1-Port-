...
public class RedstoneSpiderModel<T extends RedstoneSpiderEntity> extends HierarchicalModel<T> {
    ...
    public static LayerDefinition createRedstoneSpiderBodyLayer() {
        ...
        partdefinition.addOrReplaceChild("body1", CubeListBuilder.create().texOffs(0, 12).addBox(-5.0F, -4.0F, -6.0F, 10.0F, 8.0F, 12.0F, new CubeDeformation(0.0F))
                .texOffs(30, 32).addBox(-4.0F, -5.0F, -4.0F, 8.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 15.0F, 9.0F));
