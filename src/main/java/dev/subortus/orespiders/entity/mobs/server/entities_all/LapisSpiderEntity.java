...
public class LapisSpiderEntity extends Spider {
    public LapisSpiderEntity(EntityType<? extends Spider> pEntityType, Level pLevel) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(4, new LapisSpiderAttackGoal(this));
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Monster.createMonsterAttributes()
                ...
                .add(Attributes.ATTACK_DAMAGE, 2.50f);
    }
    ...
    static class LapisSpiderAttackGoal extends MeleeAttackGoal {
        public LapisSpiderAttackGoal(Spider pSpider) {
        ...
        protected void checkAndPerformAttack(LivingEntity pEnemy, double pDistToEnemySqr) {
            ...
            if (pDistToEnemySqr <= d0 && this.getTicksUntilNextAttack() <= 0) {
                ...
                pEnemy.addEffect(new MobEffectInstance(MobEffects.DIG_SLOWDOWN, 300, 2, true, true, true));
            }
