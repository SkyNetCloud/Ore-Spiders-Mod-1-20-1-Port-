...
public class EmeraldSpiderModel<T extends EmeraldSpiderEntity> extends HierarchicalModel<T> {
    ...
    private final ModelPart misc_crystal;

    public EmeraldSpiderModel(ModelPart pRoot) {
        this.root = pRoot;
        ...
        this.crystal = pRoot.getChild("crystal");
        this.misc_crystal = pRoot.getChild("misc_crystals");
    }

    public static LayerDefinition createEmeraldSpiderBodyLayer() {
        ...
        PartDefinition cube_r1 = crystal.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(51, 23).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.6F, -12.0F, -1.0F, 0.2705F, 0.0F, 0.0F));

        PartDefinition cube_r2 = crystal.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(51, 28).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0F, -11.0F, 0.0F, 0.0F, 0.0F, 0.2618F));

        PartDefinition cube_r3 = crystal.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(50, 25).addBox(-1.0F, -5.0F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, -11.0F, 0.0F, 0.0F, 0.0F, -0.2618F));

        PartDefinition misc_crystals = partdefinition.addOrReplaceChild("misc_crystals", CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, 0.0F));

        PartDefinition cube_r4 = misc_crystals.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(55, 22).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.0F, -5.0F, 10.0F, 0.6981F, 0.0F, -0.5236F));

        PartDefinition cube_r5 = misc_crystals.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(55, 22).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.0F, -12.0F, 10.0F, -0.829F, 0.0F, -0.5236F));

        PartDefinition cube_r6 = misc_crystals.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(55, 22).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.0F, -8.0F, 10.0F, -0.829F, 0.0F, -0.5236F));
    ...
    public void renderToBuffer(PoseStack pPoseStack, VertexConsumer pBuffer, int pPackedLight, int pPackedOverlay, float pRed, float pGreen, float pBlue, float pAlpha) {
        ...
        crystal.render(pPoseStack, pBuffer, pPackedLight, pPackedOverlay, pRed, pGreen, pBlue, pAlpha);
        misc_crystal.render(pPoseStack, pBuffer, pPackedLight, pPackedOverlay, pRed, pGreen, pBlue, pAlpha);
    }
}
